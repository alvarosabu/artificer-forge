...
<template>
  <div class="flex flex-col items-center  w-[180px] text-center font-serif">
    <div class="flex items-center justify-center gap-2 mb-1 w-full">
      <img
        v-if="portrait"
        :src="portrait"
        :alt="name"
        class="size-10 shrink-0 rounded-full object-cover border-2 border-black/50 bg-black/30 shadow-lg"
        :class="{ 'grayscale opacity-60': isDead }"
      >
